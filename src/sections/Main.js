...
export const Main = () => {
  return (
    <section
    className={`h-screen bg-[#020202] z-10 flex flex-col items-center justify-center`}
    id="section1"
  >
    <div className="relative h-full w-full px-10 md:p-0 lg:p-0 overflow-hidden">
      ...
      <div className="h-full w-full flex flex-col justify-center items-center">
        <div id="logo">
          <img src={logo} alt="logo" className="h-[380px]"  />
        </div>
        <div id="text" className="text-center my-5">
          <h1 className="md:text-5xl text-3xl font-bold">HACKATHON</h1>
        </div>
        <div className='flex py-4 p-2 col-span-2'>
         <button type="submit" className="relative px-14 py-3 font-bold group bg-[#D71015] rounded-xl hover:bg-[#B40E13] transition-all duration-300 ease-in-out"   style={{
        boxShadow: "2px 2px 0px rgba(255, 255, 255, 0.7)", // Bottom-right shadow with no blur
        }}>
           <span className="relative text-2xl text-white" style={{WebkitTextStroke: '1px #000000'}}>REGISTER NOW</span>
         </button>
        </div>
