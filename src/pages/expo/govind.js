...
export const Event = () => {
 ...
 <div className="group before:hover:scale-95 before:hover:h-[25rem] before:hover:w-[20rem] before:hover:h-70 before:hover:rounded-b-2xl before:transition-all before:duration-500 before:content-[''] before:w-80 before:h-44 before:rounded-t-2xl before:bg-gradient-to-bl from-gray-200 via-gray-200 to-gray-700 before:absolute before:top-0 md:w-[20rem] w-[10rem  ] md:h-[25rem] h-[15rem] relative bg-slate-50 flex flex-col items-center justify-center gap-2 text-center rounded-2xl overflow-hidden">
